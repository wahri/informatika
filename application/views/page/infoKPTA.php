...
<body>
	...
	<!--<header class="header"><div class="branding"><div class="container-fluid position-relative py-3">
								 <div class="logo-wrapper"><div class="site-logo"><a class="navbar-brand" href="index.html"><img class="logo-icon mr-2" src="assets/images/site-logo.svg" alt="logo" ><span class="logo-text">Informatika.umri.ac.id</span></a></div></div>
								//docs-logo-wrapper-->
	</div>
	<!--//container-->
	</div>
			...
			<div class="row">
									...
									<div class="carousel-item active">
										...
										<div class="source media flex-column flex-md-row align-items-center">
											<img class="source-profile mr-md-3" src="
																		<?= base_url('assets/infoKPTA/') ?>images/profiles/rahmad.png" alt="image">
				...
				<div class="col-12 col-md-5 mb-5 align-self-center">
					...
					<div class="text-center">
						<a class="theme-link scrollto" href="#">Baca Panduan KP Covid-19</a>
					</div>
				</div>
				<!--col-->
			</div>
	...
	<!-- Javascript -->
	<script src="<?= base_url('assets/infoKPTA/') ?>plugins/jquery-3.4.1.min.js"></script>
