<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#post">Tambah Organisasi</a>
            <div class="row">
                <div class="col-md-8">
                    <table class="table table-bordered mt-3">
                        <thead class="thead-dark">
                            <tr>
                                <th width="10%">No</th>
                                <th width="40%">Logo Organisasi</th>
                        ...
                        <tbody>
                            <?php
                            $i = 1;
                            foreach ($organisasi as $ig) :
                            ?>
                                <tr>
                                    <td class="align-middle text-center"><?= $i ?></td>
                                    <td><img src="<?= base_url('assets/images/organisasi/') . $ig['gambar'] ?>" class="img-thumbnail rounded"></td>
                                    <!-- <td class="align-bottom text-center">
                                        <a href="" class="btn btn-warning">Edit</a>
                                    </td> -->
                                    <td class="align-middle text-center">
                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal" data-idpage="<?= $ig['id_organisasi'] ?>" data-method="deletelogoorganisasi">Delete</button>
                                    </td>
                                </tr>
